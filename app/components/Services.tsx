    ...
    <>
      ...
      <div className="flex max-md:flex-wrap justify-center items-center max-xs:flex-col gap-5">
        {services.map(({ Icon, title, description }, index) => (
          <div key={index} className="overflow-hidden min-h-[230px] xs:min-h-[300px] w-[250px] p-6 rounded-2xl shadow-box bg-dark-2 flex">
            <div
             
              className="flex flex-col justify-evenly items-center text-center w-full flex-1"
